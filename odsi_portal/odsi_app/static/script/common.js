...
function setSideBarCollapse(){
	$(".paging2").find("li").on("click", function(event) {
	...
	$(".paging2").find("li").find(".sub").find("li").on("click", function(event) {
	//Set Bread crumb
...
function validateBlankEntries(form) {
 ...
 function next(element) {
    $(element).parent().parent().animate({left: '-460px'});
    $(element).parent().parent().next().animate({left: '0px'});
}
function prev(element) {
    $(element).parent().parent().animate({left: '460px'});
    $(element).parent().parent().prev().animate({left: '0px'});
}